...
%   costruisce l'array logico mr < media. Ad esempio: [0 1 0; 1 1 0]
%   Prende le posizioni dell'array logico in cui sono presenti degli 1, ma lo fa utilizzando gli indici posizionali (linearizzati), non quelli [riga, colonna].
%   Nel caso precedente considera quindi le posizioni [2 3 4] della matrice logica
